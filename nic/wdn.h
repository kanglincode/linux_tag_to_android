...
typedef struct recv_ba_ctrl_
{
    ...
    zt_lock_t pending_get_de_queue_lock; //for muti-cpu core
} recv_ba_ctrl_st;
...
typedef struct wdn_net_info_
{
    ...
    zt_u8  ssid[ZT_80211_MAX_SSID_LEN];
    zt_u8  ssid_len;
    zt_u64 tsf;
...
typedef struct
{
    ...
    zt_u32 id_bitmap; /* alloc wdn id bit map */
} wdn_list;
...
zt_s32 zt_wdn_data_update(nic_info_st *nic_info, wdn_net_info_st *wdn_info);
