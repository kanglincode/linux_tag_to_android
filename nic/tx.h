...
typedef struct tx_info
{
    ...
    zt_u8 tx_pend_flag[XMIT_DATA_BUFFER_CNT + XMIT_MGMT_BUFFER_CNT];

    /* define other needed  */
#ifdef CONFIG_XMIT_ACK
    zt_s32 ack_tx;
    zt_lock_mutex ack_tx_mutex;
...
extern zt_s32 zt_nic_mgmt_frame_xmit_with_ack(nic_info_st *nic_info,
        wdn_net_info_st *wdn, struct xmit_buf *pxmitbuf, zt_u16 len);
