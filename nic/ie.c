                                  ...
                                  zt_u8 *pie_data, zt_u8 len)
{
    ...
    {
        wdn_info->htpriv.both_20m_40m = zt_true;
    }
    else
    {
    ...
    {
        wdn_info->htpriv.mcu_ht.sgi_40m = zt_true;
    }
    else
    {
    ...
    {
        wdn_info->htpriv.dssck_40m = zt_true;
    }
    else
    {
    ...
    max_ampdu_sz = (ht_cap_temp.ampdu_params_info &
                                      ...
                                      wdn_net_info_st *wdn_info, zt_u8 *pie_data, zt_u8 len)
{
    ...
    if (hw_info->cbw40_support == zt_true)
    {
        if (ht_oper_temp.ht_param & ZT_BIT(2))
        {
            wdn_info->bw_mode = CHANNEL_WIDTH_40;
