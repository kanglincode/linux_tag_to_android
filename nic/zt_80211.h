...
#define ZT_80211_MGMT_DEAUTH_SIZE_MAX \
...
{
    return hdr_fctrl_get(hdr, ZT_80211_FCTL_STYPE | ZT_80211_FCTL_FTYPE);
}
static zt_inline
...
#define zt_80211_hdr_pm_set(hdr, en)    hdr_fctrl_set(hdr, ZT_80211_FCTL_PM, !!(en))
...
#define zt_80211_hdr_protected_set(hdr, en) \
    hdr_fctrl_set(hdr, ZT_80211_FCTL_PROTECTED, !!(en))
...
#define hdr_qctrl(hdr)  (_80211_qos_hdr(hdr)->qos_ctrl)
