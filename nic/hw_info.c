...
zt_s32 zt_hw_info_set_channnel_bw(nic_info_st *nic_info,
                                  zt_u8 channel,
                                  CHANNEL_WIDTH cw,
...
zt_s32 zt_hw_info_get_channnel_bw(nic_info_st *nic_info,
...
zt_s32 zt_hw_info_get_default_cfg(nic_info_st *pnic_info)
{
    ...
    phw_info->ba_enable   = zt_true;
    phw_info->dot80211n_support = zt_true;
    phw_info->cbw40_support = zt_true;
...
zt_s32 zt_hw_info_set_default_cfg(nic_info_st *nic_info)
{
    ...
    {
        hw_param.mac_addr[i] = hwinfo->macAddr[i]; /* write mac address */
    }
