...
#define ZT_TX_MAX_DATA_QUEUE_NODE_NUM   (XMIT_DATA_BUFFER_CNT + XMIT_MGMT_BUFFER_CNT)
#define ZT_RX_MAX_DATA_QUEUE_NODE_NUM   (14)

#ifdef CONFIG_SOFT_RX_AGGREGATION
#define ZT_MAX_RECV_BUFF_LEN_USB        (1024 * 9)
#define ZT_MAX_RECV_BUFF_LEN_SDIO       (1024 * 16)
#else
#define ZT_MAX_RECV_BUFF_LEN_USB        (1024 * 4)
#define ZT_MAX_RECV_BUFF_LEN_SDIO       (1024 * 4)
#endif
...
typedef struct trx_queue_st_
{
    ...
    zt_lock_t queu_txop_lock; //for tx queue operation lock.
